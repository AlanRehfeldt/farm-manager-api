...
export class EmployeeDto {
  ...
  @ApiProperty({
    ...
    description: 'Employment contract type (CLT or CONTRACTOR)',
    enum: EmploymentType,
  })
  ...
  @ApiPropertyOptional({
    example: 320000,
    nullable: true,
    description: 'Monthly salary in cents (CLT only)',
  })
  ...
  @ApiPropertyOptional({
    example: '160',
    nullable: true,
    description: 'Expected monthly hours reference (CLT only)',
  })
